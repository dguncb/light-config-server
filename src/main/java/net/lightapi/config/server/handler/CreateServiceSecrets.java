...
@ServiceHandler(id="lightapi.net/config/create-service-secrets/0.1.0")
public class CreateServiceSecrets implements Handler {
    ...
    public ByteBuffer handle(HttpServerExchange exchange, Object input)  {
        ...
        try {
            ...
            int recs = configRepository.createServiceSecrets(configValues.getValues(),configValues.getConfigServiceId());
