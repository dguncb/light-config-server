...
public class TemplatePathPattern {
  private final String[] splits;

  public TemplatePathPattern(String pathPattern) {
  ...
  public static TemplatePathPattern parse(String pathPattern) {
    return new TemplatePathPattern(pathPattern);
  }
  ...
  public boolean isSatisfiedBy(ConfigKeyValuePath mr) {
  ...
  public Map<String, String> getPathVariableValues(ConfigKeyValuePath mr) {
